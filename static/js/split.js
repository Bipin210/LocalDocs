...
processBtn.addEventListener('click', async () => {
    ...
    try {
        ...
        if (data.success && data.files) {
            result.querySelector('p').textContent = `PDF split into ${data.files.length} pages.`;
            ...
            showError(data.error || 'An error occurred during splitting.');
        }
    } catch (err) {
        showError('Failed to split file. Please try again.');
    } finally {
